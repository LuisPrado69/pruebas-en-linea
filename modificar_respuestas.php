...
<div class="content-wrapper">
    ...
    <section class="content">
                ...
                <hr>
                <div class="datagrid">
                    <form method='post' class="form-horizontal form-label-left" action="bddatos/ModificaRespuestaBD.php" enctype="multipart/form-data">
                        <span class="section">
                            <?php
...
?>
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-3">
                                ...
                                <a href="SubRespuestas.php" class="btn btn-danger">Cancelar</a>
                                </center>
                            </div>
                        </div>
                    </form>
