...
$r5 = mysqli_query($con,"DELETE FROM ayuda WHERE qid='$qid' ") or die('Error');
}
...
$ay=$_POST[$i.'5'];
$qa=mysqli_query($con,"INSERT INTO ayuda VALUES  ('$qid','$ay')") or die('Error61');
...
$q=mysqli_query($con,"UPDATE `history` SET `level`=$sn,`wrong`=$w, date=NOW() WHERE  email = '$email' AND eid = '$eid'")or die('Error147');
}
if($sn != $total)
{
$sn++;
