...
?>
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input id="telefono" class="form-control col-md-7 col-xs-12"  name="telefono" onkeypress="return controltag(event)" required="required" onkeypress="return controltag(event)" type="numeric" value="<?php echo $eamf["telefono"] ?>">
                            </div>
                        </div>
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input id="celular" class="form-control col-md-7 col-xs-12" onkeypress="return controltag(event)"  name="celular" required="required" onkeypress="return controltag(event)" type="numeric" value="<?php echo $eamf["celular"] ?>">
                            </div>
                        </div>
